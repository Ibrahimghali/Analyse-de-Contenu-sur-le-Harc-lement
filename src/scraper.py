...
async def main():
    ...
    try:
        ...
        keywords = ["#harassment", "#bullying", "#cyberbullying", "online harassment", 
                   "workplace bullying", "#stopbullying"]
    ...
    try:
        ...
        groups = ["StopBullyingGroup", "AntiHarassmentChat", "CyberBullyingAwareness"]
